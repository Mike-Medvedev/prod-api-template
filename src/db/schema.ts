import { pgTable, pgEnum, integer, varchar, bigint, check, boolean, timestamp, doublePrecision, index, uuid, text } from "drizzle-orm/pg-core";
...
export const commitment = pgTable('commitment', {
  ...
  check("age_check1", sql`${table.stakeAmount} between 1 and 10000`),
]);
